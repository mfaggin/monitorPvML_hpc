...
# using full MC for training/testing
#treePvSingle = TreeHandler('../produceMLTrees/treeLHC22l1b2_single.root', 'dpgCollsBigML')
#treePvSDuplicate = TreeHandler('../produceMLTrees/treeLHC22l1b2_duplicated.root', 'dpgCollsBigML')
#
# Pb-Pb 5.36 TeV, MC anchored to LHC22s_pass5
# using only run 529418 of MC for training/testing
treePvSingle = TreeHandler('../produceMLTrees/treeLHC22l1b2_single_418.root', 'dpgCollsBigML')
treePvSDuplicate = TreeHandler('../produceMLTrees/treeLHC22l1b2_duplicated_418.root', 'dpgCollsBigML')
...
singlePV = treePvSingle.get_subset('fIsDuplicate < 1') #, size=duplicatePV.get_n_cand())
